        ...
        <main className="max-w-[960px] mx-auto px-6 pt-12 pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-stretch">
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 md:p-10 border border-[#E5E7EB] flex flex-col">
              ...
              <form onSubmit={handleSignup} className="space-y-4 flex-1">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full h-[48px] px-4 bg-white border border-[#E5E7EB] rounded-[8px] text-[15px] focus:border-[#3B82F6] outline-none transition-all placeholder:text-[#9CA3AF] appearance-none" 
                    />
                  </div>
                  <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full h-[48px] px-4 bg-white border border-[#E5E7EB] rounded-[8px] text-[15px] focus:border-[#3B82F6] outline-none transition-all placeholder:text-[#9CA3AF] pr-10 appearance-none" 
                  />
                ...
                <button 
                  type="submit" 
                  className="w-full h-[52px] bg-[#313E50] text-white rounded-[10px] font-bold text-[15px] hover:bg-[#252f3d] active:bg-[#1a1f36] transition-all"
                >
              ...
              <button className="w-full h-[52px] bg-white border border-[#E5E7EB] rounded-[10px] flex items-center justify-center gap-3 text-[15px] font-semibold text-[#1a1f36] hover:bg-[#F9FAFB] active:bg-[#F3F4F6] transition-all">
            ...
            <div className="bg-white rounded-[12px] p-6 sm:p-8 border-[1.5px] border-[#4FA1FF] relative flex flex-col mt-4 lg:mt-0">
              ...
              <div>
                <button 
                  ...
                  className="w-full bg-[#313E50] text-white py-[14px] rounded-[8px] font-semibold text-[13px] mb-3 hover:bg-[#252f3d] active:bg-[#1a1f36] transition-all appearance-none"
                >
